...
minute_hand = Line([(CENTER_X, CENTER_Y), (CENTER_X, CENTER_Y)], width=5, color="#000000")
second_hand = Line([(CENTER_X, CENTER_Y), (CENTER_X, CENTER_Y)], width=2, color="#ff0000")
